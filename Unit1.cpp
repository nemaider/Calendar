...
void get_event(String user,String year,String month,String day,TLabel *label)
{
        MYSQL *connect=conn.connect_db();
        if(connect==NULL)
               return;
...
void add_event(String user,String nazwa,String year,String month,String day, String godz, String min)
{
        MYSQL *connect=conn.connect_db();
        if(connect==NULL)
               return;
...
void __fastcall TForm1::Button1Click(TObject *Sender)
{
        ...
        get_event(user->Caption,rok,miesiac,day,Label12);
...
void __fastcall TForm1::Button42Click(TObject *Sender)
{
        ...
        {
                add_event(user->Caption,Edit1->Text,Label13->Caption,Label14->Caption,Label15->Caption, Edit2->Text, Edit3->Text);
        }
